          ...
          <div class="col-xl-12 mx-auto">
            ...
            <div class="card-body p-4">
              ...
              <div class="col-md-4">
                ...
                placeholder="Room Type Name" value="{{ $editData['type']['name'] }}">
              </div>
              <div class="col-md-4">
                <label for="input2" class="form-label">Total Adult</label>
                <input type="text" name="total_adult" class="form-control" id="input2"
                placeholder="Total Adult" value="{{ $editData->total_adult }}">
              </div>
              <div class=" col-md-4">
                <label for="input2" class="form-label">Total Child</label>
                <input type="text" name="total_child" class="form-control" id="input2"
                placeholder="Total Child" value="{{ $editData->total_child }}">
              </div>
              <div class="col-md-6">
                <label for="input3" class="form-label">Main Image</label>
                <input type="file" name="image" class="form-control" id="image" placeholder="Main Image">

                <img id="showimage" src="{{ (!empty($editData->image)) ? url('upload/roomimg/' . $editData->image) :
    url('upload/no_image.jpg') }}" alt="Image" class="p-1 bg-primary" width="80" height="80">
          ...
          @endforeach
              ...
              <div class="col-md-12">
                ...
                placeholder="Short Description ..." rows="3">{{ $editData->short_desc }}</textarea>
              </div>
          ...
          <div class="basic_facility_section_remove" id="basic_facility_section_remove">
            ...
            <option value="Smoke alarms" {{$item->facility_name == 'Smoke alarms' ? 'selected' : ''}}>
              Smoke alarms</option>

            <option value="Minibar" {{$item->facility_name == 'Complimentary Breakfast' ? 'selected' : ''}}> Minibar</option>

            <option value="Work Desk" {{$item->facility_name == 'Work Desk' ? 'selected' : ''}}>
              Work
              Desk</option>

            <option value="Free Wi-Fi" {{$item->facility_name == 'Free Wi-Fi' ? 'selected' : ''}}>
              Free
              Wi-Fi</option>

            <option value="Safety box" {{$item->facility_name == 'Safety box' ? 'selected' : ''}}>
              Safety box</option>

            <option value="Rain Shower" {{$item->facility_name == 'Rain Shower' ? 'selected' : ''}}>
              Rain Shower</option>

            <option value="Slippers" {{$item->facility_name == 'Slippers' ? 'selected' : ''}}>
              Slippers
            </option>

            <option value="Hair dryer" {{$item->facility_name == 'Hair dryer' ? 'selected' : ''}}>
              Hair
              dryer</option>
          ...
          <div class="card">
            ...
            <div class="roomnoHide" id="roomnoHide">
              ...
              <div class="row">
                ...
                <input type="text" name="room_no" class="form-control" id="input2" placeholder="Room Number"
                  value="">
                </div>
          ...
          <a href="{{ route('edit.roomno', $item->id) }}"
            class="btn btn-success px-3 radius-30">Edit</a>
