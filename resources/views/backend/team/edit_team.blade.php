  ...
  <div class="page-content">
    ...
    <div class="ps-3">
      ...
      <ol class="breadcrumb mb-0 p-0">
        ...
        <li class="breadcrumb-item active" aria-current="page">Edit Team Mamber</li>
      </ol>
      </nav>
    </div>
      ...
      <div class="col-lg-12">
        ...
        <form action="{{ route('team.update') }}" method="post" enctype="multipart/form-data">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-9 text-secondary">
            <input type="text" name="tweeter" class="form-control" value="{{ $team->tweeter}}" />
            </div>
          </div>
          <div class="row mb-3">
            <div class="col-sm-3">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-9 text-secondary">
            <img id="showimage" src="{{ asset($team->image) }}" alt="Mamber Image"
          ...
          <div class="row">
            ...
            <a href="{{ route('all.team') }}" class="btn btn-outline-danger px-5 radius-30">Cancel
            </a>
            </div>
          </div>
          </div>
