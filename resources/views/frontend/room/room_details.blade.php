...
@section('main')
                ...
                <div class="col-lg-6">
                  ...
                  <div class="services-bar-widget">
                    ...
                    <div class="side-bar-list">
                      <ul>
                        <li>
                          <a href="#"> <b>Capacity : </b> {{ $roomdetails->room_capacity }} Person <i
  ...
  <div class="room-details-other pb-70">
    <div class="container">
      ...
      <div class="row ">
        @foreach ($otherRooms as $otheroom)
              ...
              <div class="row align-items-center">
                <div class="col-lg-5 col-md-4 p-0">
                  <div class="room-card-img">
                    <a href="{{ url('room/details/' . $otheroom->id) }}">
                      <img src="{{ asset('upload/roomimg/' . $otheroom->image) }}" alt="Images">
                    </a>
                  </div>
                </div>
                ...
                <div class="col-lg-7 col-md-8 p-0">
                  <div class="room-card-content">
                    <h3>
                      <a href="{{ url('room/details/' . $otheroom->id) }}">{{ $otheroom['type']['name'] }}</a>
                    </h3>
                    <span>${{ $otheroom->price }} / Per Night </span>
                    <div class="rating">
                    ...
                    <p>{{ $otheroom->short_desc }}</p>
                    <ul>
                      <li><i class='bx bx-user'></i> {{ $otheroom->room_capacity }} Person</li>
                      <li><i class='bx bx-expand'></i> {{ $otheroom->size }}ft2</li>
                    </ul>

                    <ul>
                      <li><i class='bx bx-show-alt'></i> {{ $otheroom->view }}</li>
                      <li><i class='bx bxs-hotel'></i>{{ $otheroom->bed_style }}</li>
                    </ul>
